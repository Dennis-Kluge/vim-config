...
hi Identifier           guifg=#9DEEF2                                  " Variablen
hi Structure            guifg=#9DEEF2                                  " Klassennamen, Klassenklammern
hi Ignore               guifg=bg 
hi Constant             guifg=#9DEEF2                   gui=none
...
" PHP Einstellungen
hi phpOperator          guifg=#ffffff                   gui=none       " =, &&, +
hi phpRelation          guifg=#ffffff                   gui=none       " ==, !=
hi phpVarSelector       guifg=#9DEEF2                   gui=none       " Dollarzeichen fuer PHP-Variablen
hi phpFunctions         guifg=#D0EF85                   gui=none       " Funktionsaufrufe
hi phpType              guifg=#D0EF85                   gui=none       " PHP interne Funktionsaufrufe(z.B. explode)
hi phpArrayPair         guifg=#ffffff                   gui=none       " Zuweisungspfeile in Arrays (=>)
hi phpMemberSelector    guifg=#9DEEF2                   gui=none       " Zuweisungspfeile fuer Objekte (->)
hi phpSuperglobal       guifg=#9DEEF2                   gui=none       " Super Globals (z.B. $_REQUEST, $this)
hi phpObjectOperator    guifg=#ffffff                   gui=none       " z.B. new
hi phpSpecialFunction   guifg=#D0EF85                   gui=none       " z.B. isset
" CSS Einstellungen
